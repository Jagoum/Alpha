            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div data-name="content" className="space-y-6">
                        <p className="text-lg">
                            Your contribution can help transform the lives of young Africans through 
                            technology education. Choose to support existing programs or create your 
                            own campaign to make a difference.
                        </p>
